...
<div class="container mx-auto px-4 py-8">
    ...
    <form method="POST" action="{{ route('admin.products.update', $product) }}">
        ...
        <div class="mb-4">
            ...
            <input type="number" step="0.01" name="price" id="price" class="border p-2 w-full" value="{{ old('price', $product->price) }}" required>
        </div>
        <div class="mb-4">
            <label for="stock" class="block">Stock</label>
            <input type="number" name="stock" id="stock" class="border p-2 w-full" value="{{ old('stock', $product->stock) }}" required>
        </div>
        <div class="mb-4">
